    ...
    <div className="intro-container">
      <div>
        ...
        <p>
          ...
          advocate for wage equality. Join us in the fight for workplace
          justice, as we strive to ensure that your skills, dedication, and
          contributions are valued and compensated fairly.{" "}
        </p>
      </div>
    </div>
  );
